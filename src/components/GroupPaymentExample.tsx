    ...
    return (
        <div className="interactive-example">
            ...
            <TabContent activeTab={activeTab}>
                ...
                <TabPane tabId="2">
                    <div className="mt-4"> The following codes allow you to create and sent to MyAlgo Connect 2 transactions group to be sign by the user. There are two alternatives to make it. Pick the one you prefere.</div>
                    <Row className="mt-3">
                        <Col>
                            <Label className="tx-label">
